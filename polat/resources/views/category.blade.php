                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
                    <div class="leftbar p-r-20 p-r-0-sm">
                        ...
                        <ul class="p-b-54">
                            ...
                            @foreach($categoryList as $maincategory)
                                ...
                                <a class="" data-toggle="collapse" href="#collapse{{$maincategory->id}}" role="button" aria-expanded="false" aria-controls="collapseExample">
                                    ...
                                    @if($maincategory->id == $category->maincategory || $maincategory->id == $category->id)
                                    <div class="collapse show" id="collapse{{$maincategory->id}}">
                                        @else
                                    ...
                                    <div class="" style="">
                                        ...
                                        @foreach($categoryList as $ct)
                                            @if($ct->maincategory == $maincategory->id)
                                            <li class="p-t-4">
                                                <a href="/category/{{$ct->slug}}" class="s-text13 active1 ml-3">
                                                        {{$ct->title}}
                                                </a>
                                            </li>
                                            @endif
                        ...
                        <div class="search-product pos-relative bo4 of-hidden">
                            <input class="s-text7 size6 p-l-23 p-r-50" type="text" name="search-product" placeholder="Ürün ara...">
